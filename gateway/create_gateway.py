...
GATEWAY_NAME = os.getenv('GATEWAY_NAME', 'Wildfire-Detection-Gateway')
ROLE_ARN = os.getenv('ROLE_ARN')
GATEWAY_DESCRIPTION = os.getenv('GATEWAY_DESCRIPTION', 'Wildfire Early-Warning and Triage Gateway')
...
try:
    ...
    print(f"Wildfire Gateway created successfully!")
    ...
    print(f"Error creating wildfire gateway: {e}")
    exit(1)
